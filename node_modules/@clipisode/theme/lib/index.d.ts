...
export declare enum SocialPrompt {
    Auto = "auto",
    None = "none",
    Instagram = "instagram",
    Twitter = "twitter",
...
export declare type ClipData = {
    id: string;
    duration: number;
    displayName: string;
};
export declare type TopicData = {
    id: string;
    title: string;
    host: {
        id: string;
...
export declare type GetElementsFn = (video: VideoData) => ThemeElement[];
