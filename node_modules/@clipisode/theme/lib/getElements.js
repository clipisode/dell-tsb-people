...
const getElements = (video) => {
    ...
    const displayNameTextProps = {
        ...
        fontSize: 44,
        lineHeight: 48,
        textAlign: _1.TextAlign.Center,
        x: SPACING,
        y: 1150,
        originY: _1.OriginY.Center,
    ...
    return [
        ...
        },
        {
            ...
            endAt: TITLEDURATION - 0.1,
            props: {
                value: (_b = (_a = video.topic) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : video.title,
                color: "#FFFFFF",
        ...
        },
        {
            ...
            animations: replyClip.duration < YOYOMIN
                ? [
                    {
                        startAt: TITLEDURATION,
        ...
        },
        {
            ...
            animations: answerClip.duration < YOYOMIN
                ? [
                    {
                        startAt: TITLEDURATION +
                            replyClip.duration +
        ...
        },
        {
            ...
            animations: [
                {
                    startAt: TITLEDURATION + replyClip.duration + answerClip.duration - 0.25,
                    endAt: TITLEDURATION + replyClip.duration + answerClip.duration + 0.25,
                    field: "alpha",
                    from: 0,
                    to: 0.8,
                },
        ...
        },
        {
            ...
            props: {
                alpha: 1,
                value: (_e = (_d = (_c = video.topic) === null || _c === void 0 ? void 0 : _c.host) === null || _d === void 0 ? void 0 : _d.promoText) !== null && _e !== void 0 ? _e : "clipisode.com",
                fontSize: 32,
                lineHeight: 45,
                y: 570,
                height: 225,
            ...
            animations: [
                {
                    startAt: TITLEDURATION + replyClip.duration + answerClip.duration + 0.0,
                ...
                {
                    startAt: TITLEDURATION + replyClip.duration + answerClip.duration + 0.8,
